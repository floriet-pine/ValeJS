...
(function(){
  ...
  function makeBoard() {
    let funcResult_1_0;
return (      funcResult_1_0 = Arr(10, Object.create({}, {})), funcResult_1_0)  }
...
return (    closure_0 = __call_8_p_0,     rowI_1_1 = __call_8_p_1,     row_1_2 = __call_8_p_2, eachI_1(row_1_2, Object.create({}, { rowI: { writable: true, value: rowI_1_1, }, playerRow_1: { writable: true, value: closure_0.playerRow, }, playerCol_1: { writable: true, value: closure_0.playerCol, }, toPrint_1: { writable: true, value: closure_0.toPrint, },})),     closure_0.toPrint.__boxee = $43__1(closure_0.toPrint.__boxee, '\n'),     blockResult0_3_3 = void(0), void(0), void(0), void(0), blockResult0_3_3)  }
...
return (    arr_2_0 = len_1_p_0,     blockResult0_6_1 = arr_2_0.length, void(0), blockResult0_6_1)  }
  ...
  function main() {
    ...
    let blockResult0_8;
    let blockResult1_4;
return ((    board_0 = makeBoard()), (    playerRow_2_1 = 4), (    playerCol_2_2 = 3), (    running_3 = true), (function(){ while (((running_3) ? function(){
return ((display(board_0, playerRow_2_1, playerCol_2_2), (      key_4 = inputKey()), (      newPlayerRow_5 = playerRow_2_1), (      newPlayerCol_6 = playerCol_2_2), (($61_$61_(key_4, 81)) ? function(){
return (        running_3 = false, void(0))
} : function(){
return (($61_$61_(key_4, 119)) ? function(){
return (          newPlayerRow_5 = $45_(newPlayerRow_5, 1), void(0))
} : function(){
return (($61_$61_(key_4, 115)) ? function(){
return (            newPlayerRow_5 = $43_(newPlayerRow_5, 1), void(0))
} : function(){
return (($61_$61_(key_4, 97)) ? function(){
return (              newPlayerCol_6 = $45_(newPlayerCol_6, 1), void(0))
} : function(){
return (($61_$61_(key_4, 100)) ? function(){
return (                newPlayerCol_6 = $43_(newPlayerCol_6, 1), void(0))
} : function(){
return void(0);
})()
;
...
, (      killedGoblin_7 = false), (($61_$61__1(board_0[newPlayerRow_5][newPlayerCol_6], '.')) ? function(){
return (        playerRow_2_1 = newPlayerRow_5,         playerCol_2_2 = newPlayerCol_6, void(0))
} : function(){
return void(0);
})()
,       blockResult0_8 = void(0), void(0), void(0), void(0), void(0), blockResult0_8), true)
} : function(){
return false;
})()
) {} })()
,     blockResult1_4 = 0, void(0), void(0), void(0), destructor(board_0), blockResult1_4)  }

  function immConcreteDestructor_7(immConcreteDestructor_7_p_0) {
return ((immConcreteDestructor_7_p_0), void(0))  }
...
return (    n_1_0 = arr_1_p_0,     generator_1_1 = arr_1_p_1,     blockResult1_2_4 = (    __blockVar_3 = Array_1(n_1_0, (    tempVarName0_1_2 = IFunction1_5(generator_1_1), tempVarName0_1_2)), destructor_2(tempVarName0_1_2), __blockVar_3), void(0), void(0), blockResult1_2_4)  }

  function drop(drop_p_0) {
return (destructor_3(drop_p_0), void(0))  }

  function not(not_p_0) {
    let output_0;
    let blockResult0_11_1;
return (    output_0 = not_p_0,     blockResult0_11_1 = __not(output_0), void(0), blockResult0_11_1)  }
...
return ((immConcreteDestructor_3_p_0, void(0)), void(0), void(0), void(0))  }
...
return (    closure_1_0 = __call_9_p_0,     cellI_1 = __call_9_p_1,     cell_2 = __call_9_p_2, (    charToPrint_3 = cell_2), ((and($61_$61_(closure_1_0.rowI, closure_1_0.playerRow_1), $61_$61_(cellI_1, closure_1_0.playerCol_1))) ? function(){
return (      charToPrint_3 = '@', void(0))
} : function(){
return void(0);
})()
,     closure_1_0.toPrint_1.__boxee = $43__1(closure_1_0.toPrint_1.__boxee, charToPrint_3),     blockResult0_5_4 = void(0), void(0), void(0), void(0), void(0), blockResult0_5_4)  }
...
return (    left_2_0 = $60__p_0,     right_2_1 = $60__p_1,     blockResult0_16_2 = __lessThanInt(left_2_0, right_2_1), void(0), void(0), blockResult0_16_2)  }
...
return (    left_1_0 = and_p_0,     right_1_1 = and_p_1,     blockResult0_15_2 = __and(left_1_0, right_1_1), void(0), void(0), blockResult0_15_2)  }
...
return (    left_3_0 = $61_$61__1_p_0,     right_3_1 = $61_$61__1_p_1,     blockResult0_19_2 = __eqStrStr(left_3_0, right_3_1), void(0), void(0), blockResult0_19_2)  }
...
return __call_11(__call_4_p_0.anonSubstructMember0, __call_4_p_1)  }
  ...
  function inputKey() {
    ...
    let done_1;
    let funcResult_2;
return ((    key_1_0 = 0), (    done_1 = false), (function(){ while (((not(done_1)) ? function(){
return ((      key_1_0 = __getch(), (($61_$61_(key_1_0, 81)) ? function(){
return (        done_1 = true, void(0))
} : function(){
...
, (      funcResult_2 = key_1_0, void(0), void(0), funcResult_2))  }
...
return immConcreteDestructor_1(immInterfaceDestructor_3_p_0)  }
  ...
  function Arr(arr_p_0, arr_p_1) {
    ...
    let __blockVar_3;
    let tempVarName0_2;
return (    n_0 = arr_p_0,     generator_1 = arr_p_1,     blockResult1_1_4 = (    __blockVar_3 = ValeArray(n_0, (    tempVarName0_2 = IFunction1_4(generator_1), tempVarName0_2)), destructor_1(tempVarName0_2), __blockVar_3), void(0), void(0), blockResult1_1_4)  }

  function immConcreteDestructor_6(immConcreteDestructor_6_p_0) {
return ((immConcreteDestructor_6_p_0), void(0), void(0))  }

  function $43__1($43__1_p_0, $43__1_p_1) {
    let a_0;
    let b_1;
    let blockResult0_13_2;
return (    a_0 = $43__1_p_0,     b_1 = $43__1_p_1,     blockResult0_13_2 = __addStrStr(a_0, b_1), void(0), void(0), blockResult0_13_2)  }

  function __call_12(__call_12_p_0, __call_12_p_1) {
return (void(0), drop(__call_12_p_1))  }
...
return (    left_0 = $45__p_0,     right_1 = $45__p_1,     blockResult0_10_2 = __subtractIntInt(left_0, right_1), void(0), void(0), blockResult0_10_2)  }
...
return ((immConcreteDestructor_2_p_0, void(0)), void(0), void(0), void(0), void(0))  }

  function $43_($43__p_0, $43__p_1) {
    let a_1_0;
    let b_1_1;
    let blockResult0_14_2;
return (    a_1_0 = $43__p_0,     b_1_1 = $43__p_1,     blockResult0_14_2 = __addIntInt(a_1_0, b_1_1), void(0), void(0), blockResult0_14_2)  }

  function destructor_1(destructor_1_p_0) {
return ((destructor_1_p_0), void(0), void(0))  }
...
return (    size_0 = valeArray_p_0,     generator_2_1 = valeArray_p_1,     blockResult0_17_2 = (function(){
const __size = size_0;
...
return __arr;
})(), void(0), void(0), blockResult0_17_2)  }
...
return (    arr_1_0 = eachI_1_p_0,     func_1_1 = eachI_1_p_1, (    i_1_2 = 0), (    l_1_3 = len_1(arr_1_0)), (function(){ while ((($60_(i_1_2, l_1_3)) ? function(){
return ((__call_9(func_1_1, i_1_2, arr_1_0[i_1_2]),       i_1_2 = $43_(i_1_2, 1), void(0)), true)
} : function(){
return false;
})()
) {} })()
,     blockResult0_4_4 = void(0), void(0), void(0), void(0), void(0), blockResult0_4_4)  }

  function Array_1(array_1_p_0, array_1_p_1) {
    let size_1_0;
    let generator_3_1;
    let blockResult0_18_2;
return (    size_1_0 = array_1_p_0,     generator_3_1 = array_1_p_1,     blockResult0_18_2 = (function(){
...
return __arr;
})(), void(0), void(0), blockResult0_18_2)  }

  function __call_10(__call_10_p_0, __call_10_p_1) {
    let closure_2_0;
    let row_2_1;
    let blockResult0_8_2;
return (    closure_2_0 = __call_10_p_0,     row_2_1 = __call_10_p_1,     blockResult0_8_2 = Arr_1(10, Object.create({}, { row: { writable: true, value: row_2_1, },})), void(0), void(0), blockResult0_8_2)  }
...
return (    left_4_0 = $61_$61__p_0,     right_4_1 = $61_$61__p_1,     blockResult0_20_2 = __eqIntInt(left_4_0, right_4_1), void(0), void(0), blockResult0_20_2)  }

  function print(print_p_0) {
    let output_1_0;
    let blockResult0_12_1;
return (    output_1_0 = print_p_0,     blockResult0_12_1 = __print(output_1_0), void(0), blockResult0_12_1)  }
...
return (    arr_0 = eachI_p_0,     func_1 = eachI_p_1, (    i_2 = 0), (    l_3 = len(arr_0)), (function(){ while ((($60_(i_2, l_3)) ? function(){
return ((__call_8(func_1, i_2, arr_0[i_2]),       i_2 = $43_(i_2, 1), void(0)), true)
} : function(){
return false;
})()
) {} })()
...
return (    arr_3_0 = len_p_0,     blockResult0_7_1 = arr_3_0.length, void(0), blockResult0_7_1)  }
...
return (    closure_3_0 = __call_11_p_0,     col_1 = __call_11_p_1,     blockResult0_9_2 = (($61_$61_(closure_3_0.row, 0)) ? function(){
return '#';
} : function(){
...
, void(0), void(0), blockResult0_9_2)  }
  ...
  function display(display_p_0, display_p_1, display_p_2) {
    ...
    let __blockVar_5;
return (    board_1_0 = display_p_0,     playerRow_3_1 = display_p_1,     playerCol_3_2 = display_p_2, (    toPrint_2_3 = Object.create({}, { __boxee: { writable: true, value: '', },})), eachI(board_1_0, Object.create({}, { toPrint: { writable: true, value: toPrint_2_3, }, playerRow: { writable: true, value: playerRow_3_1, }, playerCol: { writable: true, value: playerCol_3_2, },})), print(toPrint_2_3.__boxee),     blockResult0_1_4 = void(0),     (display_p_0, __blockVar_5), void(0), void(0), void(0), blockResult0_1_4)  }

  function __call_13(__call_13_p_0, __call_13_p_1) {
return (void(0), immDrop(__call_13_p_1))  }
...
return ((immConcreteDestructor_4_p_0), void(0))  }
